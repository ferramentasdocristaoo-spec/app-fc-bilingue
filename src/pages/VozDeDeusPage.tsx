...
const VozDeDeusPage = () => {
  ...
  return (
    <PageShell title="Voz de Deus">
      <div className="max-w-sm mx-auto flex flex-col items-center gap-6 pt-8">
        <p className="text-center text-sm text-muted-foreground leading-relaxed">
          Clique no botão abaixo e receba uma promessa bíblica aleatória para meditar e fortalecer sua fé hoje.
        </p>
        ...
        {promessa && (
          <div className="menu-card flex-col items-center gap-4 gold-glow text-center animate-fade-in">
            <p className="text-lg text-foreground italic leading-relaxed font-light">
              "{promessa.texto}"
            </p>
